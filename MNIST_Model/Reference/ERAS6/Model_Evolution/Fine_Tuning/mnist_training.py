...
def main():
    ...
    config.training.learning_rate = 0.04
    config.training.momentum = 0.9
    config.data.batch_size = 64
    config.training.scheduler_step_size = 10
    config.logging.log_level = 'DEBUG'
    
    # Flexible optimizer and scheduler choices
    # Optimizer options: 'SGD', 'Adam', 'AdamW', 'RMSprop'
    config.training.optimizer_type = 'AdamW'  # Change to 'Adam', 'AdamW', or 'RMSprop' as needed
    
    # Scheduler options: 'StepLR', 'CosineAnnealingLR', 'ExponentialLR', 'ReduceLROnPlateau'
    config.training.scheduler_type = 'StepLR'  # Change as needed
    
    # Example configurations for different optimizers:
    # For Adam/AdamW:
    # config.training.optimizer_type = 'Adam'
    # config.training.learning_rate = 0.001  # Adam typically uses lower LR
    # config.training.adam_betas = (0.9, 0.999)
    
    # For CosineAnnealingLR:
    # config.training.scheduler_type = 'CosineAnnealingLR'
    # config.training.cosine_t_max = 20
