...
SENSOR_ANGLE = 15    # FIX ME! Angle spread of sensors (degrees) - Too narrow!
SPEED = 2          # FIX ME! Forward speed (pixels/step) - Way too fast!
TURN_SPEED = 0.5  # FIX ME! Regular turn angle (degrees/step) - Too slow! --0.5
SHARP_TURN = 25      # FIX ME! Sharp turn angle for tight corners (degrees) - Too small!
...
LR = 0.005            # FIX ME! Learning rate for neural network optimizer
